(()=>{
  ...
  const loadV16=()=>add('scanner-v16-core.js?v=16.0.0',()=>add('scanner-v16-binder.js?v=16.0.0',()=>add('scanner-v16-market.js?v=16.0.0',()=>add('scanner-v16-ui.js?v=16.0.0',()=>add('scanner-v16-overlay.js?v=16.0.0')))));
