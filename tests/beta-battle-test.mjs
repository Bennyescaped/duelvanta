...
must(html,'beta-product-visuals.css?v=1','cinematic Battle visuals missing');
...
for(const component of ['.battle-beta .battle-hero-vs','.battle-beta .battle-hero-card'])must(visuals,component,'Battle cinematic component missing');
console.log('PASS: DUELVANTA cinematic Battle surface preserves safety, WebRTC and arena DOM contracts');
