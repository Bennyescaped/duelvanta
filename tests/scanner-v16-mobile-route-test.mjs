...
assert.ok(route.includes('scanner-v16-host.js?v=16.13.0'));
assert.ok(route.includes('scanner-v16-loader.js?v=16.13.0'));
...
assert.ok(loader.includes('scanner-v16-runtime.js?v=16.13.0'));
assert.ok(loader.includes('scanner-v16-camera.js?v=16.13.0'));
assert.ok(loader.includes('scanner-v16-native-camera.js?v=16.13.0'));
