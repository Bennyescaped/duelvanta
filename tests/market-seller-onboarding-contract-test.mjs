...
must(js,"window.DV_SUPABASE.environment==='preview'",'Stripe sandbox control must be restricted to the centrally resolved preview environment');
...
must(admin,"window.DV_SUPABASE.environment==='preview'",'synthetic owner fallback must be restricted to the centrally resolved preview environment');
