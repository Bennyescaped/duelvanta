...
try{
 ...
 console.log('PASS: auth boundary allows beta/active BATTLE accounts, blocks suspended/restricted/null access, and privileged RPCs require AAL2 plus a live session');
