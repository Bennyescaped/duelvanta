...
(async()=>{
  ...
  try{
    ...
    assert(document.getElementById('dvBuyMsg').textContent.trim().length>0&&!document.getElementById('dvBuyNow').disabled,'Netzwerkfehler sichtbar und erneut versuchbar');
