...
try{
  ...
  await db.exec(`update dv_market_private.market_payment_configuration set sandbox_enabled=true,platform_fee_bps=200,platform_fee_fixed_cents=40;
    insert into dv_market_private.market_stripe_accounts(seller_id,stripe_account_id,onboarding_status,charges_enabled,payouts_enabled,details_submitted)
    values('${SELLER}','acct_TestSeller','ready',true,true,true);set role service_role;`);
