...
(() => {
  'use strict';
  const labels = {pending:'OFFEN',accepted:'ANGENOMMEN',declined:'ABGELEHNT',withdrawn:'ZURÜCKGEZOGEN',expired:'ABGELAUFEN'};
