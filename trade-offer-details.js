...
(() => {
  ...
  renderOffers=async function(){
    ...
    $('grid').innerHTML=(data||[]).map(o=>{
      ...
      const contract=o.status==='accepted'?'<div class="dvOfferContract">VERTRAG GESCHLOSSEN · Der Verkäufer hat dein verbindliches Preisangebot angenommen. Ein weiterer Checkout ist für den Vertragsschluss nicht erforderlich.</div>':'';
