(()=>{
  ...
  if(securityMsg){const mfaButton=document.createElement('button');mfaButton.type='button';mfaButton.className='gold';mfaButton.textContent='2FA / AUTHENTICATOR VERWALTEN';mfaButton.style.marginTop='10px';mfaButton.onclick=()=>location.assign('mfa.html?manage=1&next=profile.html');securityMsg.parentNode.insertBefore(mfaButton,securityMsg.nextSibling)}
